...
namespace SSHLog
{
    public class DisplayOutput : Form
    {
        public static ListBoxLog listBoxLog;
        public DisplayOutput(ListBox listBox1)
        {
    ...
    {
        //private const string DEFAULT_MESSAGE_FORMAT = "{1} [{5}] : {8}";
        private const string DEFAULT_MESSAGE_FORMAT = "{0} : {8}";
